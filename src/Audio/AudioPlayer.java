...
public class AudioPlayer {
	...
	// HashMap data storage with key / value 
		// pairs: String = key; Clip = value
	...
	public static void load(String s, String n) {
		...
		try {			
			...
			clip.open(dais);
			// allocating a group of new objects under
			// clips main, all with same type
			clips.put(n, clip);
		}
		catch(Exception e) {
			e.printStackTrace();
	...
	public static void setVolume(String s, float i) {
		// Volume control <-80 -- +80>
	...
	public static void setLoaded(boolean b) { loaded = b; }
