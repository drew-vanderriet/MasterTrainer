...
public class BlueDragon extends Creature {
	...
	//=======================================
	// actions available to Blue Dragon
	//=======================================
...
//		type = Creature.BLUE;
//		name = "Blue Dragon";
		data.get(0).setData("Blue Dragon");
		data.get(1).setData(Creature.BLUE);

		// Creature's stats
		calStats();
		fireBalls = new ArrayList<FireBall>();

		// adding Blue Dragon's unique actions, 
		...
		sprites.add(Content.BlueDragon[0]);
		sprites.add(Content.BlueDragon[1]);
		sprites.add(Content.BlueDragon[2]);
		sprites.add(Content.BlueDragon[3]);
		sprites.add(Content.BlueDragon[4]);
		sprites.add(Content.BlueDragon[5]);
		sprites.add(Content.BlueDragonScratch[6]);
		sprites.add(Content.BlueDragon[6]);
